...
contains
    ...
    end function encode_ascii_dataarray1_rank1_R16P
    ...
    end function encode_ascii_dataarray1_rank1_R8P
    ...
    end function encode_ascii_dataarray1_rank1_R4P
    ...
    end function encode_ascii_dataarray1_rank1_I8P
    ...
    end function encode_ascii_dataarray1_rank1_I4P
    ...
    end function encode_ascii_dataarray1_rank1_I2P
    ...
    end function encode_ascii_dataarray1_rank2_R16P
    ...
    end function encode_ascii_dataarray1_rank2_R8P
    ...
    end function encode_ascii_dataarray1_rank2_R4P
    ...
    end function encode_ascii_dataarray1_rank2_I8P
    ...
    end function encode_ascii_dataarray1_rank2_I4P
    ...
    end function encode_ascii_dataarray1_rank2_I2P
    ...
    end function encode_ascii_dataarray1_rank3_R16P
    ...
    end function encode_ascii_dataarray1_rank3_R8P
    ...
    end function encode_ascii_dataarray1_rank3_R4P
    ...
    end function encode_ascii_dataarray1_rank3_I8P
    ...
    end function encode_ascii_dataarray1_rank3_I4P
    ...
    end function encode_ascii_dataarray1_rank3_I2P
    ...
    end function encode_ascii_dataarray1_rank4_R16P
    ...
    end function encode_ascii_dataarray1_rank4_R8P
    ...
    end function encode_ascii_dataarray1_rank4_R4P
    ...
    end function encode_ascii_dataarray1_rank4_I8P
    ...
    end function encode_ascii_dataarray1_rank4_I4P
    ...
    end function encode_ascii_dataarray1_rank4_I2P
    ...
    end function encode_ascii_dataarray3_rank1_R16P
    ...
    end function encode_ascii_dataarray3_rank1_R8P
    ...
    end function encode_ascii_dataarray3_rank1_R4P
    ...
    end function encode_ascii_dataarray3_rank1_I8P
    ...
    end function encode_ascii_dataarray3_rank1_I4P
    ...
    end function encode_ascii_dataarray3_rank1_I2P
    ...
    end function encode_ascii_dataarray3_rank3_R16P
    ...
    end function encode_ascii_dataarray3_rank3_R8P
    ...
    end function encode_ascii_dataarray3_rank3_R4P
    ...
    end function encode_ascii_dataarray3_rank3_I8P
    ...
    end function encode_ascii_dataarray3_rank3_I4P
    ...
    end function encode_ascii_dataarray3_rank3_I2P
    ...
    end function encode_ascii_dataarray3_rank3_I1P
    ...
    end function encode_binary_dataarray1_rank1_R8P
    ...
    function encode_binary_dataarray1_rank1_R4P(x) result(code)
        ...
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank1_R4P
    ...
    function encode_binary_dataarray1_rank1_I8P(x) result(code)
        ...
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank1_I8P
    ...
    function encode_binary_dataarray1_rank1_I4P(x) result(code)
        ...
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank1_I4P
    ...
    function encode_binary_dataarray1_rank1_I2P(x) result(code)
        ...
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank1_I2P
    ...
    function encode_binary_dataarray1_rank1_I1P(x) result(code)
        ...
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank1_I1P
    ...
    function encode_binary_dataarray1_rank2_R8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_R8P
    ...
    function encode_binary_dataarray1_rank2_R4P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR4P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_R4P
    ...
    function encode_binary_dataarray1_rank2_I8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_I8P
    ...
    function encode_binary_dataarray1_rank2_I4P(x) result(code)
        ...
        xp = transfer([int(nn*BYI4P, I4P), reshape(x, [nn])], xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_I4P
    ...
    function encode_binary_dataarray1_rank2_I2P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI2P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_I2P
    ...
    function encode_binary_dataarray1_rank2_I1P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI1P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank2_I1P
    ...
    function encode_binary_dataarray1_rank3_R8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_R8P
    ...
    function encode_binary_dataarray1_rank3_R4P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR4P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_R4P
    ...
    function encode_binary_dataarray1_rank3_I8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_I8P
    ...
    function encode_binary_dataarray1_rank3_I4P(x) result(code)
        ...
        xp = transfer([int(nn*BYI4P, I4P), reshape(x, [nn])], xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_I4P
    ...
    function encode_binary_dataarray1_rank3_I2P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI2P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_I2P
    ...
    function encode_binary_dataarray1_rank3_I1P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI1P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank3_I1P
    ...
    function encode_binary_dataarray1_rank4_R8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_R8P
    ...
    function encode_binary_dataarray1_rank4_R4P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYR4P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_R4P
    ...
    function encode_binary_dataarray1_rank4_I8P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI8P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_I8P
    ...
    function encode_binary_dataarray1_rank4_I4P(x) result(code)
        ...
        xp = transfer([int(nn*BYI4P, I4P), reshape(x, [nn])], xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_I4P
    ...
    function encode_binary_dataarray1_rank4_I2P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI2P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_I2P
    ...
    function encode_binary_dataarray1_rank4_I1P(x) result(code)
        ...
        call pack_data(a1=[int(nn*BYI1P, I4P)], a2=reshape(x, [nn]), packed=xp)
        call b64_encode(n=xp, code=code)
    end function encode_binary_dataarray1_rank4_I1P
    ...
    end function encode_binary_dataarray3_rank1_R8P
    ...
    function encode_binary_dataarray3_rank1_R4P(x, y, z) result(code)
        ...
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank1_R4P
    ...
    function encode_binary_dataarray3_rank1_I8P(x, y, z) result(code)
        ...
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank1_I8P
    ...
    function encode_binary_dataarray3_rank1_I4P(x, y, z) result(code)
        ...
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank1_I4P
    ...
    function encode_binary_dataarray3_rank1_I2P(x, y, z) result(code)
        ...
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank1_I2P
    ...
    function encode_binary_dataarray3_rank1_I1P(x, y, z) result(code)
        ...
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank1_I1P
    ...
    function encode_binary_dataarray3_rank3_R8P(x, y, z) result(code)
        ...
        call pack_data(a1=[int(3*nn*BYR8P, I4P)], a2=[(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                       ...
                       packed=xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_R8P
    ...
    function encode_binary_dataarray3_rank3_R4P(x, y, z) result(code)
        ...
        call pack_data(a1=[int(3*nn*BYR4P, I4P)], a2=[(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                       ...
                       packed=xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_R4P
    ...
    function encode_binary_dataarray3_rank3_I8P(x, y, z) result(code)
        ...
        call pack_data(a1=[int(3*nn*BYI8P, I4P)], a2=[(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                       ...
                       packed=xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_I8P
    ...
    function encode_binary_dataarray3_rank3_I4P(x, y, z) result(code)
        ...
        xyz = transfer([int(3*nn*BYI4P, I4P), [(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                                                ...
                                                n3=1, nn3)]], xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_I4P
    ...
    function encode_binary_dataarray3_rank3_I2P(x, y, z) result(code)
        ...
        call pack_data(a1=[int(3*nn*BYI2P, I4P)], a2=[(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                       ...
                       packed=xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_I2P
    ...
    function encode_binary_dataarray3_rank3_I1P(x, y, z) result(code)
        ...
        call pack_data(a1=[int(3*nn*BYI1P, I4P)], a2=[(((x(n1, n2, n3), y(n1, n2, n3), z(n1, n2, n3), n1=1, nn1), &
                       ...
                       packed=xyz)
        call b64_encode(n=xyz, code=code)
    end function encode_binary_dataarray3_rank3_I1P
